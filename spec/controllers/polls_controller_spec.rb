...
RSpec.describe PollsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new poll" do

        post :create, params: {poll: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(poll_url(Poll.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new poll" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the poll" do
        poll = Poll.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the poll" do
        poll = Poll.create! valid_attributes
