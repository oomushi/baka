module MessagesHelper
  ...
  def new_subobject_div(name, f, association, options={})
    ...
    content_tag(:p,link_to_void(image_tag("theme-default/new.svg", alt: name),data: {rif: id, unique: options[:unique]},class: "button",title: name)) + content_tag( :template, fields, id: id)
  end
end
